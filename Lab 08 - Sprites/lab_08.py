...
SCREEN_WIDTH = 800
SCREEN_HEIGHT = 600
rock_sound = arcade.load_sound("../Lab 12 - Final Lab/arcade_resources_sounds_rockHit2.wav")
hurt_sound = arcade.load_sound("../Lab 12 - Final Lab/arcade_resources_sounds_hurt4.wav")
...
class MyGame(arcade.Window):
    ...
    def setup(self):
        ...
        self.rock_sound = arcade.load_sound("../Lab 12 - Final Lab/arcade_resources_sounds_rockHit2.wav")

        self.score = 0

        self.player_sprite = arcade.Sprite("../Lab 12 - Final Lab/slimeBlue_move.png", SPRITE_SCALING_PLAYER)
        ...
        for i in range(HEALTH_COUNT):
            ...
            health = Health("../Lab 12 - Final Lab/tankGreen_barrel3.png", SPRITE_SCALING_HEALTH)
